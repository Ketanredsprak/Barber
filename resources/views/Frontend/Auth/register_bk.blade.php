                                                ...
                                                <div class="input-group-prepend">
                                                    <select class="form-control" id="country_code" name="country_code"
                                                        ...
                                                        @foreach (country_code() as $country_code)
                                                            <option value="{{ $country_code }}" {{ $country_code == 966 ? 'selected' : '' }}>+ {{ $country_code }}
                                                            </option>
                                                        @endforeach
                                                  ...
                                                  <input class="form-control" id="phone" name="phone" type="text" pattern="[0-9]*" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '');"
                                                    placeholder="{{ __('labels.Phone Number') }}" aria-label="{{ __('labels.Phone Number') }}" value="{{ old('phone') }}" maxlength="10">
                                                @error('phone')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
