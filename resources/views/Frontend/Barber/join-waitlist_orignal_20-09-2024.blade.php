            ...
            <form method="POST" action="{{ route('join-waitlist') }}" class="theme-form" id="join_wait_list_form">
                ...
                <div class="whitebox">
                    ...
                    <div class="row d-none" id="select_time_section">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <select class="form-control customTimePicker" id="select_time"
                                    name="selected_time[]"></select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row d-none" id="time_range_section">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <select class="form-control customTimePicker" id="from_time" name="from_time[]"></select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <select class="form-control customTimePicker" id="to_time" name="to_time[]"></select>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#add_preference").click(function() {
                ...
                html +=
                    `<div class="row d-none" id="select_time_section_${i}"><div class="col-sm-4"><div class="form-group"><select class="form-control customTimePicker" name="selected_time[${i}]" id="select_time_${i}" ></select></div></div></div>`;
                html +=
                    `<div class="row d-none" id="time_range_section_${i}"><div class="col-sm-4"><div class="form-group"><select class="form-control customTimePicker" name="from_time[${i}]" id="from_time_${i}"></select></div></div><div class="col-xs-1 dash"><p>&mdash;</p></div><div class="col-sm-4"><div class="form-group">
                        <select class="form-control customTimePicker"  name="to_time[${i}]" id="to_time_${i}"></select>
                    </div></div></div>`;
                html += `</div>`;
