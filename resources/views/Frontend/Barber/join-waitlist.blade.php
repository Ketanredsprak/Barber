    ...
    <script>
        $(document).ready(function() {
            ...
            $("#any_date_button").click(function() {
                ...
                $("input[name='selected_date[]']").attr("required", false);
            ...
            $("#select_date_range_button").click(function() {
                ...
                $("#any_date").prop("checked", false);
                $("#select_date").prop("checked", false);
                $("input[name='from_date[]'], input[name='to_date[]']").attr("required", true);
                $("input[name='selected_date[]']").attr("required", false);
                $("input[name='selected_date[]']").val("");
                updateAddPreferenceVisibility();
            });
            ...
            $("#add_preference").click(function() {
                ...
                html +=
                    `<span class="button-radio"><button type="button" class="btn btn-light mb-3" id="any_date_button_${i}"><input type="radio" class="hidden" name="any_date[${i}]" id="any_date_${i}" value="1" />{{ __('labels.Any Date') }}</button></span>`;
                html +=
                    `<span class="button-radio"><button type="button" class="btn btn-light mb-3" id="select_date_button_${i}"><input type="radio" class="hidden" name="select_date[${i}]" id="select_date_${i}" value="1" />{{ __('labels.Select Date') }}</button></span>`;
                html +=
                    `<span class="button-radio"><button type="button" class="btn btn-light mb-3" id="select_date_range_button_${i}"><input type="radio" class="hidden" name="select_date_range[${i}]" id="select_date_range_${i}" value="1" />{{ __('labels.Select Date Range') }}</button></span>`;
                html +=
                ...
                html +=
                    `<span class="button-radio"><button type="button" class="btn btn-light mb-3" id="select_time_button_${i}"><input type="radio" class="hidden" name="select_time[${i}]" id="select_time_${i}" value="1" />{{ __('labels.Select Time') }}</button></span>`;
                html +=
                ...
                html +=
                    `<div class="row d-none" id="select_time_section_${i}"><div class="col-sm-4"><div class="form-group"><input type="time" class="form-control" placeholder="{{ __('labels.Select Time') }}" name="selected_time[${i}]" id="select_time_${i}" ></div></div></div>`;
                html +=
                    `<div class="row d-none" id="time_range_section_${i}"><div class="col-sm-4"><div class="form-group"><input type="time" class="form-control" placeholder="{{ __('labels.From Time') }}" name="from_time[${i}]" id="from_time_${i}" ></div></div><div class="col-xs-1 dash"><p>&mdash;</p></div><div class="col-sm-4"><div class="form-group"><input type="time" class="form-control" placeholder="{{ __('labels.To Time') }}" name="to_time[${i}]" id="to_time_${i}" ></div></div></div>`;
                html += `</div>`;
            ...
            function addPreferenceEventListeners(index) {
                $(`#any_date_button_${index}`).click(function() {
                    ...
                    $(`input[name='selected_date[${index}]']`).attr("required", false);
                    $(`input[name='from_date[${index}]'], input[name='to_date[${index}]']`).attr("required",
                        false);
                    $(`input[name='selected_date[${index}]']`).val("");
