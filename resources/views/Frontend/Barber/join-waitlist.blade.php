        ...
        <div class="container">
            <div class="wait-list-wrapper">
                ...
                <form method="POST" action="{{ route('join-waitlist') }}" class="theme-form" id="join_wait_list_form">
                    ...
                    <input type="hidden" class="hidden" name="select_date[]" id="select_date" checked value="1" />
                    ...
                    <div class="whitebox">
                        ...
                        <div class="row " id="select_date_section">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="app">
                                        <div class="app__main_new">
                                            <div class="calendar">
                                                <div id="calendar"></div>
                                            </div>
                                        </div>
                        ...
                        <span class="button-radio d-none">
                        ...
                        <div class="row d-none" id="time_range_section">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <select class="form-control custom-select" id="from_time" name="from_time[]">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <select class="form-control custom-select" id="to_time" name="to_time[]">
                                        <option value="00:00">00:00</option>
                                        <option value="00:30">00:30</option>
                                        <option value="01:00">01:00</option>
                                        <option value="01:30">01:30</option>
                        ...
                        <div class="date mt-3 d-none" id="add_preference">
                            <h5 id="add_more_preference">
                                <labels>{{ __('labels.Add other time range') }}</labels>
                            </h5>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#select_date_button").click(function() {
                ...
                $("input[name='selected_date[]']").attr("required", true);
                $("input[name='from_date[]'], input[name='to_date[]']").attr("required", false);
            ...
            $("#any_time_button").click(function() {
                ...
                $("input[name='selected_time[]']").attr("required", false);
                $("input[name='from_time[]'], input[name='to_time[]']").attr("required", false);
                $("input[name='selected_time[]']").val("");
                $("input[name='from_time[]'], input[name='to_time[]']").val("");
                updateAddPreferenceVisibility();
                clearPreferences();
            });
            ...
            $("#select_time_button").click(function() {
                ...
                $("#select_time_range").prop("checked", false);
                $("input[name='selected_time[]']").attr("required", true);
                $("input[name='from_time[]'], input[name='to_time[]']").attr("required", false);
                $("input[name='from_time[]'], input[name='to_time[]']").val("");
                updateAddPreferenceVisibility();
            });
            ...
            $("#select_time_range_button").click(function() {
                ...
                $("#any_time").prop("checked", false);
                $("#select_time").prop("checked", false);
                $("input[name='from_time[]'], input[name='to_time[]']").attr("required", true);
                $("input[name='selected_time[]']").attr("required", false);
                $("input[name='selected_time[]']").val("");
                updateAddPreferenceVisibility();
            });
            ...
            $("#add_preference").click(function() {
                ...
                html += `<hr>`;
                html +=
                    `<div class="row d-none" id="select_date_section_${i}"><div class="col-sm-4"><div class="form-group"><input type="date" class="form-control" placeholder="{{ __('labels.Select Date') }}" name="selected_date[${i}]" id="select_date_${i}" min="{{ $today }}" ></div></div></div>`;
                html += `<div class="date"><h5>{{ __('labels.Time') }}</h5></div>`;
                html +=
                    `<span class="button-radio"><button type="button" class="btn btn-light mb-3" id="any_time_button_${i}"><input type="radio" class="hidden" name="any_time[${i}]" id="any_time_${i}" value="1" />{{ __('labels.Any Time') }}</button></span>`;
                html +=
                    `<span class="button-radio  d-none"><button type="button" class="btn btn-light mb-3" id="select_time_button_${i}"><input type="radio" class="hidden" name="select_time[${i}]" id="select_time_${i}" value="1" />{{ __('labels.Select Time') }}</button></span>`;
                html +=
                    `<span class="button-radio"><button type="button" class="btn btn-light mb-3" id="select_time_range_button_${i}"><input type="radio" class="hidden" name="select_time_range[${i}]" id="select_time_range_${i}" value="1" />{{ __('labels.Select Time Range') }}</button></span>`;
                html +=
                    `<button type="button" class="btn btn-sm remove-preference"><i class="fa fa-trash" aria-hidden="true"></i></button>`;
                html +=
                    `<div class="row d-none" id="time_range_section_${i}"><div class="col-sm-4"><div class="form-group">
                        <select class="form-control" name="from_time[${i}]" id="from_time_${i}">
...
<option value="00:00">00:00</option>
                        ...
                        </div></div><div class="col-xs-1 dash"><p>&mdash;</p></div><div class="col-sm-4"><div class="form-group">
                        <select class="form-control"  name="to_time[${i}]" id="to_time_${i}">
            ...
            function addPreferenceEventListeners(index) {
                $(`#select_date_button_${index}`).click(function() {
                    ...
                    $(`input[name='selected_date[${index}]']`).attr("required", true);
                    $(`input[name='from_date[${index}]'], input[name='to_date[${index}]']`).attr("required",
                        false);
                    $(`input[name='from_date[${index}]'], input[name='to_date[${index}]']`).val("");
                });
                ...
                $(`#any_time_button_${index}`).click(function() {
                    ...
                    $(`input[name='selected_time[${index}]']`).attr("required", false);
                    $(`input[name='from_time[${index}]'], input[name='to_time[${index}]']`).attr("required",
                        false);
                    $(`input[name='from_time[${index}]'], input[name='to_time[${index}]']`).val("");
                    checkRemovePreference(index);
                });
                ...
                $(`#select_time_button_${index}`).click(function() {
                    ...
                    $(`#select_time_range_${index}`).prop("checked", false);
                    $(`input[name='selected_time[${index}]']`).attr("required", true);
                    $(`input[name='from_time[${index}]'], input[name='to_time[${index}]']`).attr("required",
                        false);
                    $(`input[name='from_time[${index}]'], input[name='to_time[${index}]']`).val("");
                });
                ...
                $(`#select_time_range_button_${index}`).click(function() {
                    ...
                    $(`input[name='from_time[${index}]'], input[name='to_time[${index}]']`).attr("required",
                        true);
                    $(`input[name='selected_time[${index}]']`).attr("required", false);
                    $(`input[name='selected_time[${index}]']`).val("");
                });
            }

            function checkRemovePreference(index) {
                // Check if both any_date and any_time are selected for the new preference
                if ($(`#any_date_${index}`).is(":checked") && $(`#any_time_${index}`).is(":checked")) {
                    $(`#preference_${index}`).remove();
                }
            }

            // Initial call for the first set of preferences
            addPreferenceEventListeners(i);
        });
        ...
        function generateTimeOptions() {
            const selectElements = document.getElementsByClassName('customTimePicker');
            ...
            for (let i = 0; i < 48; i++) { // 48 slots of 30 minutes in a day
                ...
                // Append the option to all select elements with class 'customTimePicker'
                for (let j = 0; j < selectElements.length; j++) {
                    selectElements[j].appendChild(optionElement.cloneNode(true));
                }

                startTime.setMinutes(startTime.getMinutes() + 30); // Add 30 minutes for each interval
            }
        }

        // Call the function on page load to populate time options
    ...
    function setDateInInput(booking_date) {
        ...
        $(document).on('change', 'select[name^="to_time"]', function() {
            validateTimeSelection($(this).closest('div[id^="preference_"]'));
        });

        function validateTimeSelection(preferenceDiv) {
            // Get selected values
            var fromTime = preferenceDiv.find('select[name^="from_time"]').val();
            var toTime = preferenceDiv.find('select[name^="to_time"]').val();

            // Compare times
            if (fromTime && toTime && toTime <= fromTime) {
                // Reset to_time or alert the user
                preferenceDiv.find('select[name^="to_time"]').val("00:00"); // Set to a default or initial value
                var message = "{{ __('labels.To time must be greater than From time.') }}";
        ...
        $(document).on('change', 'select[name="to_time[]"]', function() {
            validateTimeRange($(this).closest('.row[id="time_range_section"]'));
        });

        function validateTimeRange(timeRangeDiv) {
            // Get selected values
            var fromTime = timeRangeDiv.find('select[name="from_time[]"]').val();
            var toTime = timeRangeDiv.find('select[name="to_time[]"]').val();

            // Compare times
            if (fromTime && toTime && toTime <= fromTime) {
                // Reset to_time to a default value or alert user
                timeRangeDiv.find('select[name="to_time[]"]').val("00:00"); // Reset to default
                var message = "{{ __('labels.To time must be greater than From time.') }}";
                toastr.error(message);
