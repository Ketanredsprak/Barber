 ...
 <div class="container">
     <nav class="navbar navbar-expand-lg">
         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent">
             <ul class="navbar-nav ml-auto">
                 <li class="nav-item active">
                     <a class="nav-link" href="{{ route('index') }}">{{ __('labels.Home') }}</a>
                 </li>
                 <li class="nav-item">
                     <a class="nav-link" href="">{{ __('labels.Services') }}</a>
                 </li>
                 <li class="nav-item">
                     <a class="nav-link" href="javascript:void(0);">{{ __('labels.Find Barber') }}</a>
                 </li>
                 <li class="nav-item">
                     <a class="nav-link" href="javascript:void(0);">{{ __('labels.Packages') }}</a>
                 </li>
                 <li class="nav-item">
                     <a class="nav-link" href="{{ route('about-us') }}">{{ __('labels.About Us') }}</a>
                 </li>
                 <li class="nav-item">
                     <a class="nav-link" href="{{ route('contact-us') }}">{{ __('labels.Contact Us') }}</a>
                 </li>
                 <div class="dropdown">
         ...
         @guest
         @else
             <div class="notifications-item"> <span><a href=""><img
             ...
             @else
                 <div class="dropdown profile_btn">
                     <button class="btn btn-outline-warning dropdown-toggle" type="button" data-toggle="dropdown">
                         <img src="{{ static_asset('frontend/assets/images/profile.png') }}">
