                            ...
                            <div class="col-sm-6">
                                <div class="checkbox">
                                    <label class="checkbox-wrapper mb-3">
                                        <input type="checkbox" class="checkbox-input service-checkbox-reshedule" name="service_ids[]"
                                            value="{{ $service->sub_service_detail->id }}" readonly disabled @if (in_array($service->sub_service_detail->id, $booking->service_Ids)) checked @endif />
                                        <span
