...
@section('content')
    ...
    <section class="explore_sec pt-75 pb-75">
        ...
        <div class="container">
            ...
            <form method="POST" action="{{ route('reschedule-booking-submit') }}" class="theme-form"
                id="reshedule_booking_form">
                            ...
                            <div class="whitebox2 mt-4">
                                ...
                                <div class="service_box">
                                    ...
                                    <div class="service_info1">
                                        ...
                                        <input type="hidden" class="form-control" id="total_services" name="total_services"
                                            value="{{ $booking->total_services }}">
                ...
                <fieldset class="checkbox-group mt-3">
                    ...
                    <div class="row">
                        ...
                        @foreach ($barber_data['barber_services'] as $key => $service)
                            <div class="col-sm-6">
                                ...
                                <div class="checkbox">
                                    ...
                                    <label class="checkbox-wrapper mb-3">
                                        ...
                                        <input type="checkbox" class="checkbox-input service-checkbox-reshedule"
                                            name="service_ids[]" value="{{ $service->sub_service_detail->id }}" readonly
                                            disabled @if (in_array($service->sub_service_detail->id, $booking->service_Ids)) checked @endif />

                                        <span
                                            class="checkbox-tile @if (in_array($service->sub_service_detail->id, $booking->service_Ids)) checkbox-tile-selected @endif">
                                            ...
                                            <span class="checkbox-label">
                                                ...
                                                <p class="price">${{ $service->service_price }} -
                                                    {{ __('labels.30 min') }}</p>
...
@section('footer-script')
    ...
    function setDateInInput(booking_date) {
        ...
        const formattedDate = `${year}-${month}-${day}`;
            ...
            var barber_id = $("#barber_id").val();

            // Get the CSRF token from the meta tag

            var csrfToken = $('meta[name="csrf-token"]').attr('content');

            // AJAX call to send the date via POST method

            $.ajax({

                url: "{{ route('get-barber-slots-reshedule') }}", // Replace with your server endpoint
                ...
                success: function(response) {
                    ...
                    $("#slotList").append(response);

                },

                error: function(xhr, status, error) {

                    toastr.error("{{ __('error.something went wrong') }}");
        ...
        $(document).ready(function() {
            ...
            $("#reshedule_booking_form").submit(function(e) {
