...
@section('content')
    ...
    <section class="explore_sec pt-75 pb-75">
        <div class="container">
            ...
            <form method="POST" action="{{ route('booking') }}" class="theme-form" id="booking_form">
                @csrf
                                ...
                                <label class="checkbox-wrapper mb-3">
                                    ...
                                    <span class="checkbox-tile">
                                        <span class="checkbox-label">
                                            ...
                                            <div class="checked-img"><img src="{{ static_asset('frontend/assets/images/check_mark.webp') }}" alt="image"></div>
                                        </span>
                                    </span>
                                </label>
                            </div>
...
@section('footer-script')
    ...
    function setDateInInput(booking_date) {
        ...
        const formattedDate = `${year}-${month}-${day}`;
            ...
            $.ajax({
                url: "{{ route('get-barber-slots') }}", // Replace with your server endpoint
                type: 'POST',
                data: {
                ...
                error: function(xhr, status, error) {
                    toastr.success("{{ __('error.something went wrong') }}");
                }
            });
