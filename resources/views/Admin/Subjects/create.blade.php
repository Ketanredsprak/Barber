<div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel1"> {{ __('labels.Add Subject') }}</h5>
            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close" onclick="return close_or_clear();"></button>
        </div>
        <div class="modal-body" id="myModal">
            <form class="form-bookmark" method="post" action="{{ route('subject.store') }}" id="subject-frm">
                @csrf
                <div class="row g-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="name_en" name="name_en" type="text"
                            placeholder="{{ __('labels.Subject Name English') }}" aria-label="{{ __('labels.Subject Name English') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="name_ar" name="name_ar" type="text"
                            placeholder="{{ __('labels.Subject Name Arabic') }}" aria-label="{{ __('labels.Subject Name Arabic') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="name_ur" name="name_ur" type="text"
                            placeholder="{{ __('labels.Subject Name Urdu') }}" aria-label="{{ __('labels.Subject Name Urdu') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="name_tr" name="name_tr" type="text"
                            placeholder="{{ __('labels.Subject Name Turkish') }}" aria-label="{{ __('labels.Subject Name Turkish') }}">
