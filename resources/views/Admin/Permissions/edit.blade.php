<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel1">{{ __('labels.Edit Permission') }}</h5>
        ...
        <div class="modal-body" id="myModal">
            <form class="form-bookmark" method="post" action="{{ route('permission.update', $data->id) }}" id="permission-edit-form">
                ...
                <button class="btn btn-primary btn-sm btn-custom" type="submit" id="permissionSubmit"><i class="fa fa-spinner fa-spin d-none icon"></i> {{ __('labels.Submit') }}</button>
