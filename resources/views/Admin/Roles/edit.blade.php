    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id="myModal">
            <form class="form-bookmark" method="post" action="{{ route('role.update', $role->id) }}" id="role-edit-form">
                ...
                <div class="row g-2">
                    ...
                    <div class="mb-3 col-md-12">
                        ...
                        <input class="form-control" id="name" name="name" type="text"
                            placeholder="{{ __('labels.Name') }}" aria-label="{{ __('labels.Name') }}" value="{{ $role->name }}">
                ...
                <button class="btn btn-primary btn-sm btn-custom" type="submit" id="roleSubmit"><i class="fa fa-spinner fa-spin d-none icon"></i> {{ __('labels.Submit') }}</button>
