                                ...
                                <tbody>
                                    ...
                                    @foreach ($todays_bookings as $todays_booking)
                                        <tr>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            @php
                                                                ...
                                                                $profileImage =
                                                                    $todays_booking->customer_detail->profile_image;
                                                                ...
                                                                $imageUrl = $profileImage
                                                                    ...
                                                                    : $baseUrl .
                                                                        'public/admin/assets/images/user/user.png';

                                                            @endphp

                                                            <img class="b-r-8" height="40px" width="40px"
                                                                src="{{ $imageUrl }}" alt="Generic image">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            @php
                                                                ...
                                                                $profileImage =
                                                                    $todays_booking->barber_detail->profile_image;
                                            ...
                                            <td>{{ date('Y-M-d', strtotime($todays_booking->booking_date)) }} , {{ date('h:i A', strtotime($todays_booking->start_time)) }} - {{ date('h:i A', strtotime($todays_booking->end_time)) }}
                                            ...
                                            <td>
                                                ...
                                                @if ($status === 'pending')
                                                    <span class="badge bg-warning">{{ __('labels.Pending') }}</span>
                                                @elseif ($status === 'reject')
                                                    <span class="badge bg-danger">{{ __('labels.Rejected') }}</span>
                                                @elseif ($status === 'cancel')
                                                    <span class="badge bg-danger">{{ __('labels.Cancelled') }}</span>
                                                @elseif ($status === 'accept')
                                                    <span class="badge bg-success">{{ __('labels.Accepted') }}</span>
