                                ...
                                <div class="tab-content" id="top-tabContent">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($barber_bookings as $barber_booking)
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        $barber_booking_name =
                                                                            'barber_booking_name_' . $language; // Construct dynamic barber_booking name key

                                                                        // Check if barber_booking detail exists and display the barber_booking name
                                                                        $barber_booking_name_value =
                                                                            $barber_booking->barber_booking_detail
                                                                                ->{$barber_booking_name} ?? '';
                                                                    @endphp
                                                                    ...
                                                                    {{ $barber_booking_name_value }}
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            @if ($status === 'pending')
                                                                                <span
                                                                                    class="badge bg-secondary">{{ __('Pending') }}</span>
                                                                            @elseif ($status === 'reject')
                                                                                <span
                                                                                    class="badge bg-danger">{{ __('Reject') }}</span>
                                                                            @elseif ($status === 'cancel')
                                                                                <span
                                                                                    class="badge bg-danger">{{ __('Cancel') }}</span>
                                                                            @elseif ($status === 'accept')
                                                                                <span
                                                                                    class="badge bg-success">{{ __('Accept') }}</span>
                                    ...
                                    <div class="tab-pane fade" id="top-profile" role="tabpanel"
                                        ...
                                        <div class="">
                                            ...
                                            <div class="">
                                                <div class="table-responsive">
                                                    <div id="basic-5_wrapper" class="dataTables_wrapper no-footer">
                                                        <div class="dataTables_length" id="basic-5_length">

                                                        </div>


                                                        <table class="display dataTable no-footer" id="basic-5"
                                                            role="grid" aria-describedby="basic-5_info">
                                                            <thead>
                                                                ...
                                                                @foreach ($userSubscriptions as $subscription)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            @endphp
                                                                            {{-- <!-- Debug: Display the raw status value -->
                                                                                   <p>Raw Status: {{ $status }}</p> --}}
