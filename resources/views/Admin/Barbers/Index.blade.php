                            ...
                            <table class="display barber-data">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th id="remove_id_class">{{ __('labels.ID') }}</th>
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#remove_id_class').removeClass('sorting_asc');
            $('#remove_id_class').removeClass('sorting');
            $('#remove_id_class').removeClass('sorting_desc');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        jQuery.each(response, function(index, item) {
                            ...
                            $('#stateData').append(' <option value=' + item['id'] +
                                ' >' + item['name_en'] + '</option>  ')
