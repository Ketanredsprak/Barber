            ...
            <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar-list">
                    <a id="dropdownMenuButton1"
                        class="dropdown-toggle sidebar-link sidebar-title d-flex align-items-center justify-content-between @if (request()->routeIs('page.index','page.edit','get-website-config')) badge-light-primary @endif"
                    ...
                    <ul  class="sidebar-submenu dropdown-menu @if (request()->routeIs('page.index', 'page.edit','get-website-config')) show @endif" aria-labelledby="dropdownMenuButton1" >
                        @if (auth()->user()->can('page-list'))
                        <li>
                            <a href="{{ route('page.index') }}"
                                class="@if ($url == 'page.index' || $url == 'page.create' || $url == 'page.edit') badge-light-primary @endif">
                                <span>{{ __('labels.CMS Page') }}</span>
                            </a>
                        </li>
                        @endif
                        @if (auth()->user()->can('website-config-list'))
                        <li>
                            <a href="{{ route('get-website-config') }}"
                                class="@if (request()->routeIs('get-website-config')) badge-light-primary @endif">
                                <span>{{ __('labels.System Setting') }}</span>
                            </a>
                        </li>
                        @endif
                ...
                <li class="sidebar-list">
                    ...
                    <ul  style="transform:none;" class="sidebar-submenu dropdown-menu @if (request()->routeIs('subadmin.report', 'customer.report', 'barber.report','booking.report')) show @endif" aria-labelledby="dropdownMenuButton1">
                        <li>
