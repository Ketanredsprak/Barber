<div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel1">{{ __('labels.Add State') }}</h5>
                ...
                <div class="row g-2">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" id="state_name_en" name="state_name_en" type="text"
                            placeholder="{{ __('labels.State Name English') }}" aria-label="{{ __('labels.State Name English') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" id="state_name_ar" name="state_name_ar" type="text"
                            placeholder="{{ __('labels.State Name Arabic') }}" aria-label="{{ __('labels.State Name Arabic') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" id="state_name_ur" name="state_name_ur" type="text"
                            placeholder="{{ __('labels.State Name Urdu') }}" aria-label="{{ __('labels.State Name Urdu') }}">
