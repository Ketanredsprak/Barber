              ...
              <table width="560" border="0" cellspacing="0" cellpadding="0" align="center" class="templetcontainer">
                ...
                <tr>
                  <td align="left" valign="top"
                    ...
                    <h2>Welcome to Ehjez!</h2>
                    <p>Hi [{{ $name }}],</p>
                    <p>Thank you for joining Ehjez! We're excited to have you on board, we're committed to providing you with the best experience possible.</p>
                </td>
                </tr>
                <tr>
                  <td height="40">&nbsp;</td>
