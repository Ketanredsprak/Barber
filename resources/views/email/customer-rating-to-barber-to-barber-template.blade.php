              ...
              <table width="560" border="0" cellspacing="0" cellpadding="0" align="center" class="templetcontainer">
                ...
                <tr>
                  <td align="left" valign="top"
                    ...
                    <h2>Rating Received from [{{ @$booking->customer_detail->first_name ?? "" }} {{ @$booking->customer_detail->last_name ?? "" }}]..</h2>
                    <p>Hi [{{ $booking->barber_detail->first_name }}  {{ $booking->barber_detail->last_name }}],</p>
                    <p>Your appointment has been schedule on [{{ $booking->booking_date }}] with [{{ @$booking->customer_detail->first_name ?? "" }} {{ @$booking->customer_detail->last_name ?? "" }}].after complete appointment [{{ @$booking->customer_detail->first_name ?? "" }} {{ @$booking->customer_detail->last_name ?? "" }}] provide [{{ $rating->rating }}/5] for your service.</p>
                </td>
                </tr>
                <tr>
                  <td height="40">&nbsp;</td>
