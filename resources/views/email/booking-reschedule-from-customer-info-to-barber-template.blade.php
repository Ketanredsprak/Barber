              ...
              <table width="560" border="0" cellspacing="0" cellpadding="0" align="center" class="templetcontainer">
                ...
                <tr>
                  <td align="left" valign="top"
                    ...
                    <h2>Your Appointment is Resechedule by [{{ @$old_booking_data->customer_detail->first_name ?? "" }} {{ @$old_booking_data->customer_detail->last_name ?? "" }}]..</h2>
                    <p>Hi [{{ @$old_booking_data->barber_detail->first_name ?? "" }} {{ @$old_booking_data->barber_detail->last_name ?? "" }}], your appointment with [{{ @$old_booking_data->customer_detail->first_name ?? "" }} {{ @$old_booking_data->customer_detail->last_name ?? "" }}] at [{{ @$old_booking_data->barber_detail->first_name ?? "" }} {{ @$old_booking_data->barber_detail->last_name ?? "" }}] on [{{ @$old_booking_data->booking_date ?? "" }} {{ @$old_booking_data->start_time ?? "" }} - {{ @$old_booking_data->end_time ?? "" }}] is now resechedule on [{{ @$new_booking_data->booking_date ?? "" }} {{ @$new_booking_data->start_time ?? "" }} - {{ @$new_booking_data->end_time ?? "" }}]. for more detail please check out mobile app.</p>
