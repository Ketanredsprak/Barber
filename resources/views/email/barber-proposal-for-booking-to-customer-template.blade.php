              ...
              <table width="560" border="0" cellspacing="0" cellpadding="0" align="center" class="templetcontainer">
                ...
                <tr>
                  <td align="left" valign="top"
                    ...
                    <h2>Hi [{{ @$booking->customer_detail->first_name ?? "" }} {{ @$booking->customer_detail->last_name ?? "" }}]</h2>
                    <p>Your joinWait List to [{{ @$booking->barber_detail->first_name ?? "" }} {{ @$booking->barber_detail->last_name ?? "" }}] on [{{ @$booking->booking_date }}], now barber send proposal for this waitlist, please respond on barber proposal with accept or reject..</p>
                    <h3>Join Wait List Details</h3>
                    ...
                    <h3>Barber Proposal Details</h3>
                    <p>Barber Proposal Date : [ {{ @$booking->barber_proposal->booking_date }}]</p>
                    <p>Barber Time : [ {{ @$booking->barber_proposal->start_time }} - {{ @$booking->barber_proposal->end_time }}]</p>
