              ...
              <table width="560" border="0" cellspacing="0" cellpadding="0" align="center" class="templetcontainer">
                ...
                <tr>
                  <td align="left" valign="top"
                    ...
                    <h2>Hi [{{ @$booking->barber_detail->first_name ?? "" }} {{ @$booking->barber_detail->last_name ?? "" }}]</h2>
                    <p>Your proposal for [{{ @$booking->customer_detail->first_name ?? "" }} {{ @$booking->customer_detail->last_name ?? "" }}] on [{{ @$booking->barber_proposal->booking_date }}], Now customer respond for this proposal as [{{ @$booking->barber_proposal->status }}]</p>
                    @if($booking->barber_detail->status == "accept")
                    <p>The customer is Approved your proposal for this [ {{ @$booking->barber_proposal->booking_date }}] date.</p>
                    @endif
                    @if($booking->barber_detail->status == "reject")
                    <p>The customer is Reject your proposal for this [ {{ @$booking->barber_proposal->booking_date }}] date.</p>
                    @endif
                </td>
                </tr>
                <tr>
