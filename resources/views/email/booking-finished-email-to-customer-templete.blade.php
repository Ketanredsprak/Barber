              ...
              <table width="560" border="0" cellspacing="0" cellpadding="0" align="center" class="templetcontainer">
                ...
                <tr>
                  <td align="left" valign="top"
                    ...
                    <p>We hope you had a great experience! Your appointment with [{{ @$booking_data->barber_detail->first_name ?? "" }} {{ @$booking_data->barber_detail->last_name ?? "" }}] at [{{ @$booking_data->barber_detail->salon_name ?? "" }}] has now been completed.</p>
                    <p>Barber Name [{{ @$booking_data->barber_detail->first_name ?? "" }} {{ @$booking_data->barber_detail->last_name ?? "" }}] </p>
