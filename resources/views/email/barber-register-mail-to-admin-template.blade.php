...
@php
    $url = env('APP_URL', 'default_value').'/admin/login';
@endphp
              ...
              <table width="560" border="0" cellspacing="0" cellpadding="0" align="center" class="templetcontainer">
                ...
                <tr>
                  <td align="left" valign="top"
                    ...
                    <h2>New Barber Registered..</h2>
                    <p>Hi Admin,</p>
                    <p>We are excited to inform you that a new Barber has just registered on our website!</p>
