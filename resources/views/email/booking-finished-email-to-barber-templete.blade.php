              ...
              <table width="560" border="0" cellspacing="0" cellpadding="0" align="center" class="templetcontainer">
                ...
                <tr>
                  <td align="left" valign="top"
                    ...
                    <h2>Your Appointment is mark as Finished</h2>
                    <p>Hi [{{ @$booking_data->customer_detail->first_name ?? "" }} {{ @$booking_data->customer_detail->last_name ?? "" }}],</p>
                    <p>We hope you had a great experience! Your appointment with [{{ @$booking_data->customer_detail->first_name ?? "" }} {{ @$booking_data->customer_detail->last_name ?? "" }}] at [{{ @$booking_data->barber_detail->salon_name ?? "" }}] has now been completed.</p>
                    <p>Customer Name [{{ @$booking_data->customer_detail->first_name ?? "" }} {{ @$booking_data->customer_detail->last_name ?? "" }}] </p>
                    <p>Salon Name [{{ @$booking_data->barber_detail->salon_name ?? "" }}] </p>
                    <p>Appointment Date [{{ @$booking_data->booking_date ?? "" }}] </p>
                    <p>Appointment Start and End Time [{{ @$booking_data->start_time ?? "" }} -  {{ @$booking_data->end_time ?? "" }}] </p>
                </td>
                </tr>
                <tr>
                  <td height="40">&nbsp;</td>
