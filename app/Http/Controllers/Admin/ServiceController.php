...
class ServiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $data = Services::with('parent')->where('is_delete', 0)->orderBy('id', 'DESC')->get();
            ...
            return Datatables::of($data)->addIndexColumn()
                ...
                ->addColumn('parent_name', function ($row) {
                    ...
                    return @$row->parent->$service_name;

                })

                ->rawColumns(['action', 'status', 'service_name', 'service_image', 'is_special_service','parent_name'])
