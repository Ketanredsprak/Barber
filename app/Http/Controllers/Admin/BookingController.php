...

    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)->addIndexColumn()
                ...
                ->addColumn('booking_date_time', function ($booking) {
                    $start_time = $booking->start_time;
                    $end_time = $booking->end_time;
                    $booking_date = $booking->booking_date;
...
*/
                ...
                ->addColumn('status', function ($row) {
                    ...
                    switch ($row->status) {
                        ...
                        case 'pending':
                            ...
                            return '<span class="badge bg-warning">' . __('labels.Pending') . '</span>';

                        case 'reject':

                            return '<span class="badge bg-danger">' . __('labels.Rejected') . '</span>';

                        case 'cancel':

                            return '<span class="badge bg-danger">' . __('labels.Cancelled') . '</span>';

                        case 'accept':

                            return '<span class="badge bg-success">' . __('labels.Accepted') . '</span>';
                ...
                ->rawColumns(['barber_details', 'user_details', 'booking_date', 'start_time', 'end_time', 'total_price', 'action', 'status','booking_date_time'])
