...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $userLatitude = Cookie::get('user_latitude');
        $userLongitude = Cookie::get('user_longitude');

        return view('Frontend.home', compact('banners', 'data', 'testimonials', 'services', 'userLatitude', 'userLongitude'));
    }
    ...
    public function barberDetail($id)
    {
        ...
        $barber_data = User::with('barber_schedule', 'barber_rating', 'barber_images')->find($id);
    ...
    public function nearestBarberList(Request $request)
    {
        ...
        $topNearbyBarbers = User::with(['barber_service', 'barberRatings:barber_id,rating'])
            ...
            * sin( radians( users.latitude ) ) ) )
            ...
            ->each(function ($barber) {
                ...
                $barber['barber_location'] = strlen($barber->location) > 20 ? substr($barber->location, 0, 20) . '...' : $barber->location;
            });
    ...
    public function ratingBarberList(Request $request)
    {
    ...
    "))
        ...
        return response()->json(view('Frontend.rating-wise-barber-response', compact('topBarbers'))->render());
...
{
    $admin_email = "Ketan@redsparkinfo.co.in"; // Corrected with semicolon
    ...
    $data_email_1 = Mail::send(
        ...
        array(
            'name' => "Ketan Dabhi",
            'email' => "ketandabhi0909@gmail.com",
            'phone' => "7990644417",
        ),
        function ($message) use ($admin_email, $filePath) {
