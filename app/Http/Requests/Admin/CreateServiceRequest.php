...
class CreateServiceRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'service_image.required' => __('error.The Service image field is required.'),
            'service_image.file' => __('error.The Service image must be a file.'),
            'service_image.mimes' => __('error.The Service image must be a file of type: jpeg, png, jpg.'),
        ];
    }
}
