    ...
    public function toArray(Request $request): array
    {
        if($request->user_type ==  "customer")
        {
            return [
                ...
                'profile_image' =>  URL::to('/public/profile_image/' . ($this->barber_detail->profile_image ?: 'user.jpg')),
        ...
        else
        {
            return [
                ...
                'profile_image' => URL::to('/public/profile_image/' . ($this->customer_detail->profile_image ?: 'user.jpg')),
                'chat_unique_key' => $this->chat_unique_key ?? "",
                'last_message' => $this->last_message->message ?? "",
                'created_at' =>  date('Y-M-d h:i A', strtotime($this->created_at)),
            ];
